...
class AttributeProto(
        ...
        suspend fun decode(reader: ProtobufReader): AttributeProto {
            ...
            reader.forEachTag { tag ->
                when (ReaderTag.fromInt(tag)) {
                    ...
                    ReaderTag.TENSOR_DATA -> proto.t = reader.readTensor()
                    ...
                    ReaderTag.TENSORS_DATA -> proto.tensors.add(reader.readTensor())
    ...
    enum class AttributeType(override val value: Int) : WireEnum {
        ...
        companion object {
            val ADAPTER: ProtoAdapter<AttributeType> = object : EnumAdapter<AttributeType>(
                AttributeType::class, Syntax.PROTO_2,
                UNDEFINED
            ) {
