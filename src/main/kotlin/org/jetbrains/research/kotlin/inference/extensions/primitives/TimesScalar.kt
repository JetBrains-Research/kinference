...
fun times(array: FloatArray, scalar: Number, copy: Boolean): FloatArray {
...
fun times(array: IntArray, scalar: Number, copy: Boolean): IntArray {
...
fun times(array: LongArray, scalar: Number, copy: Boolean): LongArray {
...
fun times(array: DoubleArray, scalar: Number, copy: Boolean): DoubleArray {
...
fun times(array: ShortArray, scalar: Number, copy: Boolean): ShortArray {
