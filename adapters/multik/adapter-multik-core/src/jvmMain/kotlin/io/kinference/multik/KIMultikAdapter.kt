...
class KIMultikAdapter(model: KIModel) : ONNXModelAdapter<MultiArray<Number, Dimension>, KIONNXData<*>>(model) {
    ...
    override fun fromONNXData(data: KIONNXData<*>): MultiArray<Number, Dimension> = when (data.type) {
