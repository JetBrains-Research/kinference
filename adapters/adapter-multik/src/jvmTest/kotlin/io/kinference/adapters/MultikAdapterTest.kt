...
import io.kinference.multik.MultikAdapter
import io.kinference.multik.MultikDataType
...
class MultikAdapterTest {
    @Test
    fun test_adapter_convert_to_onnx_data() {
        ...
        val convertedTensor = MultikAdapter.toONNXData("test", multikArray as MultiArray<Number, Dimension>)
    ...
    @Test
    fun test_adapter_convert_from_onnx_data() {
