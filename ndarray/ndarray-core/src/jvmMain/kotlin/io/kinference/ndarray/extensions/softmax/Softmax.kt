...
suspend fun softmax(
    ...
    return when (input.type) {
        DataType.FLOAT -> softmaxVer13Float(input as FloatNDArray, rows, columns, stride)
        DataType.DOUBLE -> softmaxVer13Double(input as DoubleNDArray, rows, columns, stride)
