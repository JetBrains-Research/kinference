...
import io.kinference.ndarray.batchSizeByData
...
import io.kinference.ndarray.extensions.dot.DotUtils.CHUNK_SIZE
import io.kinference.ndarray.parallelizeByRowsWithLim
import io.kinference.primitives.types.PrimitiveArray

internal suspend fun lcDot(left: PrimitiveNDArray, right: PrimitiveNDArray, dest: MutablePrimitiveNDArray): MutablePrimitiveNDArray {
    val n = left.shape[0]
    val t = left.shape[1]
    val m = right.shape[1]
    ...
    parallelizeByRowsWithLim(nRowFlop, n, DotUtils.MIN_DATA_PER_LAUNCH) { nStart, nEnd, _ ->
