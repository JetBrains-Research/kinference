...
class ScatterElementsTest {
    ...
    fun test_scatter_elements_with_axis() = TestRunner.runTest {
        AccuracyRunner.runFromResources(getTargetPath("test_scatter_elements_with_axis"))
    }

    @Test
    fun test_scatter_elements_without_axis() = TestRunner.runTest {
        AccuracyRunner.runFromResources(getTargetPath("test_scatter_elements_without_axis"))
    }

    @Test
    fun test_scatter_elements_with_negative_indices() = TestRunner.runTest {
        AccuracyRunner.runFromResources(getTargetPath("test_scatter_elements_with_negative_indices"))
    }
}
