...
interface OperatorFactory<T : ONNXData<*, *>> {
    ...
    fun create(opType: String?, version: Int?, attributes: Map<String, Attribute<Any>>, inputs: List<String>, outputs: List<String>): Operator<T, T>

    fun create(proto: NodeProto, opSetRegistry: OperatorSetRegistry): Operator<T, T> {
        ...
        return create(proto.opType, version, attributes, proto.input, proto.output)
    }
}
