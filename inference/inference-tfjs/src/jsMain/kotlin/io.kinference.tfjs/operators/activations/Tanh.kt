...
sealed class Tanh(
    ...
    companion object {
        ...
        operator fun invoke(name: String, version: Int?, attributes: Map<String, Attribute<Any>>, inputs: List<String>, outputs: List<String>): Tanh {
...
class TanhVer6(
    ...
    inputs: List<String>,
    outputs: List<String>
) : Tanh(name, INFO, attributes, inputs, outputs) {
    companion object {
    ...
    override suspend fun <D : ONNXData<*, *>> apply(contexts: Contexts<D>, inputs: List<TFJSTensor?>): List<TFJSTensor?> {
        ...
        return listOf(input.tanh().asTensor("output"))
    }
}
