...
sealed class NonZero(
    ...
    companion object {
        ...
        operator fun invoke(name: String, version: Int?, attributes: Map<String, Attribute<Any>>, inputs: List<String>, outputs: List<String>): NonZero {
...
class NonZeroVer9(
    ...
    inputs: List<String>,
    outputs: List<String>
) : NonZero(name, INFO, attributes, inputs, outputs) {
    companion object {
    ...
    override suspend fun <D : ONNXData<*, *>> apply(contexts: Contexts<D>, inputs: List<TFJSTensor?>): List<TFJSTensor?> {
        val input = inputs[0]!!.data.nonZero()
        return listOf(input.asTensor("Y"))
    }
}
