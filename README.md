...
```kotlin
dependencies {
    api("io.kinference", "inference-tfjs", "0.2.3")
}
```
...
```kotlin
dependencies {
    api("io.kinference", "inference-ort", "0.2.3")
}
```
...
```kotlin
dependencies {
    api("io.kinference", "inference-ort-gpu", "0.2.3")
}
```
...
```kotlin
dependencies {
    api("io.kinference", "adater-kmath-{backend_name}", "0.2.3")
}
```
...
```kotlin
dependencies {
    api("io.kinference", "adater-multik-{backend_name}", "0.2.3")
}
```
...
kotlin {
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                api("io.kinference:inference-api:0.2.3")
                api("io.kinference:ndarray-api:0.2.3")
            }
        }
