...
object ArrayAssertions {
    ...
    fun assertEquals(expect: UShortArray, actual: UShortArray, delta: Double, tensorName: String) {
        val errorsArray = IntArray(expect.size) { i ->
            abs(expect[i].toInt() - actual[i].toInt())
        }
    ...
    fun assertEquals(expect: UShortTiledArray, actual: UShortTiledArray, delta: Double, tensorName: String) {
        val errorsArray = IntArray(expect.size) { i ->
            abs(expect[i].toInt() - actual[i].toInt())
        }
    ...
    fun assertEquals(expect: UIntArray, actual: UIntArray, delta: Double, tensorName: String) {
        val errorsArray = IntArray(expect.size) { i ->
            abs(expect[i].toInt() - actual[i].toInt())
        }
    ...
    fun assertEquals(expect: UIntTiledArray, actual: UIntTiledArray, delta: Double, tensorName: String) {
        val errorsArray = IntArray(expect.size) { i ->
            abs(expect[i].toInt() - actual[i].toInt())
        }
    ...
    fun assertEquals(expect: ULongArray, actual: ULongArray, delta: Double, tensorName: String) {
        val errorsArray = IntArray(expect.size) { i ->
            abs(expect[i].toInt() - actual[i].toInt())
        }
    ...
    fun assertEquals(expect: ULongTiledArray, actual: ULongTiledArray, delta: Double, tensorName: String) {
        val errorsArray = IntArray(expect.size) { i ->
            abs(expect[i].toInt() - actual[i].toInt())
        }
    ...
    fun assertEquals(expect: ByteTiledArray, actual: ByteTiledArray, delta: Double, tensorName: String) {
        val errorsArray = IntArray(expect.size) { i ->
            abs(expect[i].toInt() - actual[i].toInt())
        }
    ...
    fun assertArrayEquals(left: UShortTiledArray, right: UShortTiledArray, diff: (UShort, UShort) -> Double, delta: Double, message: String = "") {
        assertEquals(left.size, right.size, message)
        for (i in 0 until left.size) {
            val l = left[i]
            val r = right[i]
    ...
    fun assertArrayEquals(left: UShortArray, right: UShortArray, diff: (UShort, UShort) -> Double, delta: Double, message: String = "") {
        assertEquals(left.size, right.size, message)
        for (i in left.indices) {
            val l = left[i]
            val r = right[i]
    ...
    fun assertArrayEquals(left: UIntTiledArray, right: UIntTiledArray, diff: (UInt, UInt) -> Double, delta: Double, message: String = "") {
        assertEquals(left.size, right.size, message)
        for (i in 0 until left.size) {
            val l = left[i]
            val r = right[i]
    ...
    fun assertArrayEquals(left: ByteTiledArray, right: ByteTiledArray, diff: (Byte, Byte) -> Double, delta: Double, message: String = "") {
        assertEquals(left.size, right.size, message)
        for (i in 0 until left.size) {
            val l = left[i]
            val r = right[i]
    ...
    fun assertArrayEquals(left: ULongArray, right: ULongArray, diff: (ULong, ULong) -> Double, delta: Double, message: String = "") {
        assertEquals(left.size, right.size, message)
        for (i in left.indices) {
            val l = left[i]
            val r = right[i]
